/****************************************************************************
** Meta object code from reading C++ file 'TcpMediator.h'
**
...
#include "../../MyQQ_Client/Mediator/TcpMediator.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'TcpMediator.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 18, 12), // "SIG_readData"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 5), // "char*"
QT_MOC_LITERAL(4, 38, 3), // "buf"
QT_MOC_LITERAL(5, 42, 4), // "nlen"
QT_MOC_LITERAL(6, 47, 2) // "Ip"

    },
    "TcpClientMediator\0SIG_readData\0\0char*\0"
    "buf\0nlen\0Ip"
};
...
void TcpClientMediator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SIG_readData((*reinterpret_cast< char*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< long(*)>(_a[3]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TcpClientMediator::*)(char * , int , long );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpClientMediator::SIG_readData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TcpClientMediator::SIG_readData(char * _t1, int _t2, long _t3)
{
