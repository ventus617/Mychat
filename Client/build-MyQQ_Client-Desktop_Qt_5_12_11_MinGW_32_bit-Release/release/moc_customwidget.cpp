...
#include "../../MyQQ_Client/uiapi/customwidget.h"
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CustomMoveDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slot_showMax(); break;
        case 1: _t->slot_showMin(); break;
...
QT_INIT_METAOBJECT const QMetaObject CustomMoveDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_CustomMoveDialog.data,
    qt_meta_data_CustomMoveDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CustomMoveMainWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slot_showMax(); break;
        case 1: _t->slot_showMin(); break;
...
QT_INIT_METAOBJECT const QMetaObject CustomMoveMainWindow::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_CustomMoveMainWindow.data,
    qt_meta_data_CustomMoveMainWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
